...
**Input Format:** The only line of the input contains a string s of length 2n + 1 for some n, with symbols s_0 , s_1 , . . . , s_2n . Each symbol at an even position of s is a digit (that is, an integer from 0 to 9) while each symbol at an odd position is one of three operations from {+,-,*}.
